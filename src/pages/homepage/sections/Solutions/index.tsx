...
function Solutions({}: Props) {
  return (
    <Container id="solutions" data-section="solutions">
      ...
      >
        <Card>
          ...
          <h1>
            <Translate id="solutions.healthcare.title">Healthcare</Translate>
          </h1>

          <p className="mb-0">
            <Translate id="solutions.healthcare.description">
              A bustling multi-specialty clinic offers services ranging from
              general practice to specialized treatments. Schedly helps managing
              appointments for numerous doctors with varying schedules, handling
              last-minute cancellations, and accommodating emergency visits
