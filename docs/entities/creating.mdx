...
*Its a good idea to have familiarised yourself with GoSchedules definition of a bookable entites before reading this article.*
...
```bash
curl --request POST \
  --url https://api.goschedule.io/v1/entities \
  --header 'Content-Type: application/json' \
  --user :live_api_key_7nzvc7wsBQQISLeFSVhROys9V1bUJ1z7 \
  --data '{
    "email": "doc.brown@GoSchedule.io",
...
```json
{
  "data": {
    ...
    "calendars": [
      ...
      "provider_sync": false
      "name": "Bookings"
      "description": "Created by GoSchedule           on resource creation"
